...
void EnvelopeLibraryDialog::setupUI()
{
    ...
    QLabel *instructions = new QLabel(
        "<i>Click to add points • Drag to move • Right-click to delete • Shift+drag to snap to grid</i>");
...
void EnvelopeLibraryDialog::onSaveToFile()
{
    ...
    jsonObj["description"] = "Custom envelope created in Calamus Envelope Library";
    jsonObj["version"] = "1.0";
