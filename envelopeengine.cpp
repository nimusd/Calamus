...
{
    // Map index to envelope type (matching UI: Linear, Attack-Decay, ADSR, Fade In, Fade Out, Custom)
    switch (index) {
        ...
        case 5: envelopeType = EnvelopeType::Custom; break;  // Custom envelope
...
double EnvelopeEngine::process(double noteProgress)
{
    // Apply time scaling
    double scaledPosition = noteProgress * timeScale;
